(function () {
    ...
    ***************************************************************************** */
    ...
    class SceneNode {
        ...
        build() {
            ...
            this.m_nodeConfigs.forEach((item) => {
                ...
                NodeT.buildNode(_spr, item, this.m_prefabs, (_name) => {
    ...
    class Scene extends BaseItemPool {
        ...
        _getPrefabs(_name) {
            return ResLoad.GetRes(EssentialResUrls.PrefabURL(_name));
        }
    }
