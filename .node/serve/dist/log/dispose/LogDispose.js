...
class LogDispose {
        ...
        return new Promise((r, e) => {
            ...
            try {
                ...
                for (let _o of _urls) {
                    ...
                    _datas.push({
                        name: _name,
                        data: fs_1.readFileSync(ResURL_1.default.join(ResURL_1.default.logURL, _name + '.log_')).toString(),
                        data_: '',
                    });
                }
            }
    ...
    getLog(_name) {
        return new Promise((r, e) => {
            try {
                let _data = fs_1.readFileSync(ResURL_1.default.join(ResURL_1.default.logURL, _name + '.log_')).toString();
                let _data_ = fs_1.readFileSync(ResURL_1.default.join(ResURL_1.default.logURL, _name + '.log__')).toString();
    ...
    writeLog(_log, _log_, _key) {
        return new Promise((r, e) => {
            ...
            try {
                fs_1.writeFile(ResURL_1.default.join(ResURL_1.default.logURL, _name + '.log_'), _log, () => {
                    fs_1.writeFile(ResURL_1.default.join(ResURL_1.default.logURL, _name + '.log__'), _log_, () => {
                        r(ResponseDataT_1.default.Pack({
                            name: _name,
                        }));
                    });
